...
export const FAQ_DATABASE: FAQEntry[] = [
...

  {
    ...
    keywords: ['what', 'purpose', 'overview', 'intro', 'about', 'explain'],
  ...
  },
  {
    ...
    keywords: ['install', 'setup', 'start', 'begin', 'first', 'new', 'npm'],
  ...
  },
  {
    ...
    keywords: ['cch', 'alias', 'shorthand', 'command'],
  ...
  },
  {
    ...
    keywords: ['tools', 'supported', 'cursor', 'cline', 'gemini', 'codex', 'kimi', 'editor', 'ide'],
  ...
  },
  {
    ...
    keywords: ['habits', 'file', 'location', 'path', 'stored', 'where', 'habits.md'],
...

  {
    ...
    keywords: ['provider', 'llm', 'anthropic', 'openai', 'groq', 'ollama', 'model'],
  ...
  },
  {
    ...
    keywords: ['ollama', 'timeout', 'offline', '11434', 'connection', 'gemma', 'llama', 'refused'],
  ...
  },
  {
    ...
    keywords: ['api', 'key', 'anthropic', 'not set', 'missing', 'error', 'openai', 'groq'],
  ...
  },
  {
    ...
    keywords: ['switch', 'change', 'provider', 'anthropic', 'openai', 'groq', 'ollama'],
  ...
  },
  {
    ...
    keywords: ['rate', 'limit', '429', 'error', 'retry', 'throttle', 'too many'],
  ...
  },
  {
    ...
    keywords: ['413', 'payload', 'too large', 'batch', 'size', 'limit'],
  ...
  },
  {
    ...
    keywords: ['free', 'cost', 'price', 'groq', 'ollama', 'no key'],
...

  {
    ...
    keywords: ['hook', 'capture', 'signal', 'not working', 'missing', 'fire', 'trigger'],
  ...
  },
  {
    ...
    keywords: ['nvm', 'node', 'version', 'hook', 'path', 'binary', 'not found'],
  ...
  },
  {
    ...
    keywords: ['capture', 'signal', 'log', 'data', 'diff', 'privacy', 'stored', 'what'],
  ...
  },
  {
    ...
    keywords: ['log', 'size', 'disk', 'large', 'rotate', 'jsonl', 'grow'],
  ...
  },
  {
    ...
    keywords: ['git', 'commit', 'capture', 'history', 'past', 'git-capture'],
  ...
  },
  {
    ...
    keywords: ['ignore', 'exclude', 'disable', 'directory', 'skip', 'stop', '.cc-habits-ignore'],
...

  {
    ...
    keywords: ['learn', 'when', 'trigger', 'update', 'session', 'stop', 'automatic'],
  ...
  },
  {
    ...
    keywords: ['pending', 'review', 'approve', 'queue', 'new', 'habit'],
  ...
  },
  {
    ...
    keywords: ['signals', 'not enough', 'learn', 'minimum', '3', 'few'],
  ...
  },
  {
    ...
    keywords: ['confidence', 'score', 'number', 'percentage', 'what', 'mean'],
  ...
  },
  {
    ...
    keywords: ['decay', 'disappear', 'delete', 'gone', 'stale', 'prune', 'remove'],
  ...
  },
  {
    ...
    keywords: ['bootstrap', 'past', 'history', 'sessions', 'transcripts', 'existing'],
  ...
  },
  {
    ...
    keywords: ['tombstone', 'delete', 'prevent', 'block', 'never', 'permanent', 'remove'],
  ...
  },
  {
    ...
    keywords: ['explain', 'provenance', 'source', 'where', 'signal', 'history', 'contribute'],
  ...
  },
  {
    ...
    keywords: ['auto', 'automatic', 'skip', 'pending', 'review', 'CC_HABITS_AUTO'],
...

  {
    ...
    keywords: ['view', 'see', 'list', 'show', 'habits', 'current', 'all'],
  ...
  },
  {
    ...
    keywords: ['diff', 'change', 'between', 'compare', 'before', 'after', 'delta'],
  ...
  },
  {
    ...
    keywords: ['log', 'audit', 'capture', 'history', 'signal', 'what was sent'],
...

  {
    ...
    keywords: ['memories', 'memory', 'difference', 'habit', 'what'],
  ...
  },
  {
    ...
    keywords: ['enable', 'disable', 'memories', 'memory', 'turn on', 'turn off', 'opt in'],
  ...
  },
  {
    ...
    keywords: ['delete', 'remove', 'memory', 'specific', 'unwanted'],
...

  {
    ...
    keywords: ['sync', 'cursor', 'cline', 'share', 'export', 'agents', 'AGENTS.md', 'other tools'],
  ...
  },
  {
    ...
    keywords: ['sync', 'missing', 'AGENTS.md', 'confidence', 'threshold', 'sessions'],
  ...
  },
  {
    ...
    keywords: ['export', 'import', 'move', 'new machine', 'transfer', 'backup', 'copy'],
...

  {
    ...
    keywords: ['shell', 'shell-init', 'wrapper', 'banner', 'zsh', 'bash', 'eval'],
...

  {
    ...
    keywords: ['config', 'yml', 'yaml', 'location', 'path', 'settings', 'file'],
  ...
  },
  {
    ...
    keywords: ['CC_HABITS_DIR', 'directory', 'override', 'per project', 'custom', 'storage'],
  ...
  },
  {
    ...
    keywords: ['override', 'env', 'environment', 'variable', 'one time', 'temporary', 'provider'],
...

  {
    ...
    keywords: ['lint', 'check', 'file', 'review', 'habits', 'comply', 'follow'],
...

  {
    ...
    keywords: ['cloud', 'upload', 'send', 'privacy', 'data', 'code', 'remote', 'network'],
  ...
  },
  {
    ...
    keywords: ['pii', 'redact', 'secret', 'email', 'api key', 'credit card', 'aws', 'pem', 'token'],
  ...
  },
  {
    ...
    keywords: ['api key', 'secure', 'permissions', 'mode', '0600', 'config', 'safe'],
  ...
  },
  {
    ...
    keywords: ['injection', 'prompt injection', 'malicious', 'attack', 'security', 'sanitize', 'rule'],
...

  {
    ...
    keywords: ['migrate', 'upgrade', 'old', 'version', 'not loading', 'missing', 'path'],
  ...
  },
  {
    ...
    keywords: ['reset', 'clear', 'fresh', 'start over', 'delete', 'wipe', 'all'],
...

  {
    ...
    keywords: ['inject', 'context', 'session', 'not working', 'not showing', 'claude', 'CLAUDE.md', 'import'],
  ...
  },
  {
    ...
    keywords: ['git', 'repo', 'repository', 'commit', 'detect', 'missing', 'git-capture'],
  ...
  },
  {
    ...
    keywords: ['command not found', 'cch', 'not found', 'install', 'path', 'npm'],
  ...
  },
  {
    ...
    keywords: ['settings', 'json', 'parse', 'error', 'corrupt', 'invalid', 'comments', 'JSON5'],
  ...
  },
  {
    ...
    keywords: ['banner', 'pending', 'session', 'start', 'notification', 'every time'],
...

  {
    ...
    keywords: ['multiple', 'projects', 'separate', 'different', 'per project', 'workspace'],
  ...
  },
  {
    ...
    keywords: ['cap', '50', 'signals', 'batch', 'limit', 'why', 'max'],
  ...
  },
  {
    ...
    keywords: ['confidence', 'math', 'delta', 'initial', 'cap', 'floor', 'prune', 'values', 'numbers'],
  ...
  },
  {
    ...
    keywords: ['session', 'id', 'specific', 'learn', '--session', 'filter'],
  ...
  },
  {
    ...
    keywords: ['capture', 'adapter', 'custom', 'integrate', 'tool', 'unsupported', 'cli', '--file', '--diff'],
  ...
  },
  {
    ...
    keywords: ['provenance', 'trace', 'origin', 'signal', 'which', 'explain', 'source'],
  ...
  },
  {
    ...
    keywords: ['update', 'version', 'notice', 'check', 'npm', 'registry', 'latest'],
