...
const COPY = {
  ...
  hiwSub: "cc-habits plugs into your tool's lifecycle hooks, the same way across Claude Code, Gemini CLI, Codex, and Kimi. They run silently, locally, and never block your terminal.",
  ...
  memoriesCaption: "02  ·  what it remembers  ·  memories",
